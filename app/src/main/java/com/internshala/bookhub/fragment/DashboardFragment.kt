...
class DashboardFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        if (ConnectionManager().checkConnectivity(activity as Context)){
            ...
            dialog.setTitle("Cannot connect to the network")
            dialog.setMessage("A network connection is required to access data.")
            dialog.setPositiveButton("Set network"){text, listener ->
