...
import com.internshala.bookhub.util.ConnectionManagers
import com.internshala.bookhub.util.RESET_PASSWORD
import com.internshala.bookhub.util.Validations
...
class ResetPasswordActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnSubmitOTP.setOnClickListener {
            ...
            if (ConnectionManagers().isNetworkAvailable(this@ResetPasswordActivity)) {
            ...
            object : JsonObjectRequest(Method.POST, RESET_PASSWORD, jsonParams, Response.Listener {
                try {
                    ...
                    if (success) {
                        ...
                        builder.setMessage("You have successfully updated password.")
